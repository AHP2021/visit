...
# from Laundry.settings import STATIC_URL
# import datetime
# import time
# import math
...
# #         a = u'<span><input type="text" id="%s_display" value="%s"/><input type="hidden" %s/> %s%s</span>' % (
# #             id, dat_f, parsed_atts, self.media, cal)
# #         return mark_safe(a)
# #
...
#         self.ISLAMIC_WEEKDAYS = (
#             "al-ahad", "al-'ithnayn", "ath-thalatha'", "al-arbia`aa'", "al-khamis", "al-jumu`a", "as-sabt")
#
#         self.JALALI_EPOCH = 1948320.5;
#         self.JALALI_WEEKDAYS = (
...
#
#         return (self.GREGORIAN_EPOCH - 1) + (365 * (year - 1)) + math.floor((year - 1) / 4) + (
